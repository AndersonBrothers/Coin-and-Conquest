...
*Territories are not just valuable for the resources they give you access to, they also give 5 points per territory.*

### Resources 
Resources are vital to your Kingdom and are used to buy Cards and pay for activated abilities.\
There are 4 resource types Food, Wood, Steel, Stone, and Gold. 4 of which can be extracted with labor from its corresponding territory.

- Farm Land  = Food
- Forest = Wood
- Mine   = Steel

Gold the 4th resources can be made in a variety of way, The most basic of which is trading 4 of any resources with the Bank for one Gold.
Resources can be used to buy Cards and pay for activated abilities.

### Card Types
<p align="middle">
  <img src="/media/readme/Standard.png" width="24%" /> 
  <img src="/media/readme/Attack.png" width="24%" />
  <img src="/media/readme/Infrastructure.png" width="24%" />
  <img src="/media/readme/Contest.png" width="24%" />
</p>
<!--
### Card brackdown
